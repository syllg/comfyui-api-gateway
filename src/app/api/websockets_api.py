...
from src.app.settings.setting import BACKGROUND_REPLACEMENT_WORKFLOW, ANIME_STYLE_WORKFLOW, FACE_SWAP_WORKFLOW, BACKGROUND_REPLACEMENT_REMBG_WORKFLOW, ANIME_STYLE_FACE_SWAP_MERGE_WORKFLOW, MULTI_FACE_SWAP_WORKFLOW, FACE_SWAP_SINGLE_WORKFLOW, BACKGROUND_REPLACEMENT_MASK_WORKFLOW, SNOWY_WORKFLOW
