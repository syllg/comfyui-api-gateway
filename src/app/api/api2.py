...
from src.app.schemas.schema import BackgroundRemovalRequest, BackgroundRemovalResponse, BackgroundReplacementRequest, BackgroundReplacementResponse, AnimeStyleRequest, AnimeStyleResponse, FaceSwapResponse, ListPromptRequest, ListPromptResponse, DeletePromptRequest, AnimeTemplateRequest, ListTemplateResponse, DeleteTemplateRequest, AnimeTemplateResponse, AnimeStyleFaceSwapResponse, StatusEnum
...
async def anime_style_face_swap_merge_api(
    ...
    anime_p_prompt: str = Form("preserve original colors, same color palette as input image, detailed, anime style, expressive"),
    anime_denoise: Optional[float] = Form(0.45, ge=0.0, le=1.0),
    face_p_prompt: Optional[str] = Form(None),
    face_n_prompt: Optional[str] = Form("blurry, malformed, low quality, worst quality, artifacts, noise, text, watermark, glitch, deformed, ugly, horror, ill"),
